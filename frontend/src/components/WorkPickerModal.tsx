...
import { GetWorks, GetCollectionWorks, AddWorkToCollection } from '@wailsjs/go/main/App';
...
export function WorkPickerModal({ opened, onClose, collectionID, onUpdate }: WorkPickerModalProps) {
