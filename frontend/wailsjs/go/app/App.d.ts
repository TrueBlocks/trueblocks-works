...
export function AnalyzeCollection(arg1:number):Promise<analysis.CollectionResult>;

export function AnalyzeCollectionHeadings(arg1:number):Promise<app.CollectionHeadingAnalysisResult>;

export function AnalyzeWork(arg1:number):Promise<analysis.WorkResult>;
...
export function DismissAnnotation(arg1:number,arg2:string):Promise<void>;
...
export function GetAnalysisEnabled():Promise<boolean>;

export function GetAppState():Promise<state.AppState>;

export function GetAvailableProviders():Promise<Array<analysis.ProviderInfo>>;

export function GetBatchPDFPageSizes(arg1:Array<number>):Promise<Record<number, string>>;
...
export function GetCollectionAnalysis(arg1:number):Promise<analysis.CollectionResult>;

export function GetCollectionAnalysisHistory(arg1:number):Promise<Array<analysis.CollectionResult>>;
...
export function GetWorkAnalysis(arg1:number):Promise<analysis.WorkResult>;

export function GetWorkAnalysisHistory(arg1:number):Promise<Array<analysis.WorkResult>>;
...
export function TestProviderConnection(arg1:string,arg2:string):Promise<void>;
...
export function UndismissAnnotation(arg1:number):Promise<void>;
