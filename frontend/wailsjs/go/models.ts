...
export namespace app {
	...
	export class CopyBookPDFTextResult {
	    success: boolean;
	    error?: string;
	
	    static createFrom(source: any = {}) {
	        return new CopyBookPDFTextResult(source);
	    }
...
export namespace models {
	...
	export class Book {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.versoHeader = source["versoHeader"];
	        this.rectoHeader = source["rectoHeader"];
	        this.pageNumberPosition = source["pageNumberPosition"];
	        this.suppressPageNumbers = source["suppressPageNumbers"];
