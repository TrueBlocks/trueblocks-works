...
type Book struct {
	...
	ShowHeaders               *bool   `json:"showHeaders,omitempty" db:"show_headers"`
	BookType                  string  `json:"bookType" db:"book_type"`
	PageNumbersOnOpeningPages *bool   `json:"pageNumbersOnOpeningPages,omitempty" db:"page_numbers_on_opening_pages"`
